...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [
            {
            username: "Balluff",
            password: "$2a$08$lKXpDJeGBOhmfZIlmQqQ9uSRwSDGK4DcWxPxf9ygsJCn0KEbotXea",
            permissions: "*"
            }
        ]
    },
    ...
    editorTheme: {
        page: {
            title: "Balluff GmbH NodeRed",
            favicon: "/usr/src/app/assets/favicon.ico",
            css: "/usr/src/app/styling/bfstyle.css",
            //scripts: "/absolute/path/to/custom/js/file"  // As of 0.17
        },
        header: {
            title: "Balluff GmbH NodeRed",
            image: "/usr/src/app/assets/Balluff_Logo.png", // or null to remove image
            url: "www.balluff.com"
        },
        deployButton: {
        ...
        menu: { // Hide unwanted menu items by id. see editor/js/main.js:loadEditor for complete list
            ...
            "menu-item-help": {
                label: "get help from Balluff",
                url: "http://www.balluff.de"
            }
        },
        //userMenu: false, // Hide the user-menu even if adminAuth is enabled
        login: {
            image: "/usr/src/app/assets/thumb_iol.jpg" // a 256x256 image
        },
        logout: {
            redirect: "http://www.balluff.de" // As of 0.17
        },
        //palette: {
